...
let secondsTime = setInterval(() => {
  ...
  countUpTime.innerHTML =
    ('0' + dateTimer.getUTCMinutes()).slice(-2) + ':' + ('0' + dateTimer.getUTCSeconds()).slice(-2);
}, 10);
...
function startGame(WIDTH, HEIGHT, BOMBS_COUNT) {
  ...
  smile.innerHTML =
    '<button class="smile_button"><img src="./image/smile.png" alt="" class="smile"></button>';

  const field = document.querySelector('.field');
  const cellsCount = WIDTH * HEIGHT;
  field.innerHTML =
    '<button class="button"><img src="./image/button.png" alt="" class="img_button"></button>'.repeat(
      cellsCount
    );
  ...
  const numbers = [
    ...
    '<img src=" ./image/button_five.png" alt="" class="img_button">',
    '<img src=" ./image/button_six.png" alt="" class="img_button">',
    '<img src=" ./image/button_seven.png" alt="" class="img_button">',
    '<img src=" ./image/button_eight.png" alt="" class="img_button">',
  ];
  ...
  field.addEventListener('mousedown', (event) => {
    ...
    smile.innerHTML =
      '<button class="smile_button"><img src="./image/smile_click.png" alt="" class="smile"></button>';
  });
  ...
  function open(row, column) {
    ...
    if (isBomb(row, column)) {
      ...
      smile.innerHTML =
        '<button class="smile_button"><img src="./image/smile_button.png" alt="" class="smile"></button>';
    ...
    if (closedCount <= BOMBS_COUNT) {
      smile.innerHTML =
        '<button class="smile_button"><img src="./image/smile_won.png" alt="" class="smile"></button>';
      clearInterval(secondsTime);
      clearInterval(interval);
      return;
    }
